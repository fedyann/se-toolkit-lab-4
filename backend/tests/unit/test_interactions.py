...
def test_filter_excludes_interaction_with_different_learner_id():
    ...
    interactions = [
        InteractionModel(id=1, learner_id=1, item_id=1, kind="view", timestamp="2025-01-01"),
        InteractionModel(id=2, learner_id=2, item_id=1, kind="view", timestamp="2025-01-01"),
        InteractionModel(id=3, learner_id=1, item_id=2, kind="view", timestamp="2025-01-01"),
    ]
